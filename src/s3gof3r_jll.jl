...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import s3gof3r_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("9164d88c-a457-5bb2-a3b9-d66c3bc9d5df"))
platforms = [Pkg.Artifacts.unpack_platform(e, "s3gof3r", artifacts_toml) for e in artifacts["s3gof3r"]]
...
if best_platform === nothing
    @debug("Unable to load s3gof3r; unsupported platform $(triplet(platform_key_abi()))")
else
